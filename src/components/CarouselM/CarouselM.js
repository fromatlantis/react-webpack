...
export default class CarouselM extends PureComponent {
    ...
    //轮播图方法
    onChange = (b, a, c) => {
        let len = (this.props.CarouselMDetail && this.props.CarouselMDetail.length) || 0,
            middle = Math.ceil(this.show / 2)
        ...
        let left =
            b + 1 > middle && b + 1 < len - this.show + middle
                ? (middle - 1 - b) * 80 + 20
                : b + 1 <= middle
                ? 20
                : (this.show - len) * 80 + 20
    ...
    render() {
        return (
            <div>
                ...
                >
                    {this.props.CarouselMDetail &&
                        this.props.CarouselMDetail.map((item, index) => {
