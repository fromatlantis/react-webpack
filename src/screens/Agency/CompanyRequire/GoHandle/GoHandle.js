...
import { Button, Form, Input, Divider, Steps, Table, Select, Breadcrumb } from 'antd'
    ...
    render() {
        ...
        return (
            <div className={styles.container}>
                ...
                <div className={styles.order}>匹配供应商</div>
                <Divider />
                <Form className={styles.commonLeft} layout="inline" onSubmit={this.handleSubmit}>
