            ...
            <Fragment>
                <div className={styles.detailCard}>
                    <div className={styles.titleChip}>
                        <div>
                            ...
                            <span className={styles.title}>商标信息</span>
                        </div>
                        <div>
                            {company_id && (
                                <Button
                    ...
                    <Table
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                align: 'center',
                                render: appDate => (
                                    <span>{moment(parseInt(appDate)).format('YYYY-MM-DD')}</span>
                                ),
                            },
                            // {
                            //     title: '公司',
                ...
                <div className={styles.detailCard}>
                    <div className={styles.titleChip}>
                        <div>
                            <span className={styles.divider}>|</span>
                            <span className={styles.title}>专利信息</span>
                        </div>
                        <div>
                            {company_id && (
                                <Button
                ...
                <div className={styles.detailCard}>
                    <div className={styles.titleChip}>
                        <div>
                            <span className={styles.divider}>|</span>
                            <span className={styles.title}>软件著作权</span>
                        </div>
                        <div>
                            {company_id && (
                                <Button
                    ...
                    <Table
                        ...
                        columns={[
                            ...
                            },
                            {
                                ...
                                align: 'center',
                                render: regtime => (
                                    <span>{moment(parseInt(regtime)).format('YYYY-MM-DD')}</span>
                                ),
                            },
                            {
                                title: '登记号',
                ...
                <div className={styles.detailCard}>
                    <div className={styles.titleChip}>
                        <div>
                            <span className={styles.divider}>|</span>
                            <span className={styles.title}>作品著作权</span>
                        </div>
                        <div>
                            {company_id && (
                                <Button
                ...
                <div className={styles.detailCard}>
                    <div className={styles.titleChip}>
                        <div>
                            <span className={styles.divider}>|</span>
                            <span className={styles.title}>网站域名</span>
                        </div>
                        <div>
                            {company_id && (
                                <Button
